            ...
            <div class="left-div">
                <div class="blog-listing">
                   <?php
                    ...
                    $query="SELECT posts.*,category.title as category_title FROM posts INNER JOIN category ON posts.category = category.id WHERE posts.title like '%$keywords%' OR posts.description LIKE '%$keywords%' OR posts.content LIKE '%$keywords%' ORDER BY posts.id desc";
                    $records_per_page=3;
                    $starting_position=0;
                    ...
                    if($res['status'] == 202){
                        ...
                        echo "<h3>". $keywords ." search results</h3>";
                        echo "<hr>";
